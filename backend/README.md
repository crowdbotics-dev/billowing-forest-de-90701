...
## Project Structure
    ...
    ├── billowing_forest_de_90701  # Django project configurations
...
1. Clone this repo and `cd billowing_forest_de_90701`
...
2. Clone this repo and `cd billowing_forest_de_90701`
